...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.LDAPLoginRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/csv/diff/{type}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "File type (module/rule/store/till/var)",
                        "name": "type",
                        "in": "path",
                        "required": true
                    },
        ...
        "/rules": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by env name",
                        "name": "env_name",
                        "in": "query"
                    }
                ],
        ...
        "/stores": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by EFT type",
                        "name": "eft",
                        "in": "query"
                    }
                ],
        ...
        "/till-lists": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by host name (LIKE)",
                        "name": "host_name",
                        "in": "query"
                    },
                    {
        ...
        "/till-lists/reports": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Host name (LIKE)",
                        "name": "host_name",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "MAC address (exact)",
                        "name": "mac_address",
                        "in": "query"
                    }
                ],
        ...
        "/till-lists/{id}/reports/{reportId}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        "internal_handler.LDAPLoginRequest": {
            "type": "object",
            "required": [
                "password",
                "username"
